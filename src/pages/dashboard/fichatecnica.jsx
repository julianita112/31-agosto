...
const handleSave = async () => {
  ...
  className="overflow-auto max-h-[90vh] rounded-lg shadow-lg"
>
  <DialogHeader className="text-black p-4 border-b-2 border-gray-200">
    <Typography variant="h4" className="text-gray-800 font-bold">
      Detalles de la Ficha Técnica
    </Typography>
  </DialogHeader>
  <DialogBody divider className="overflow-auto max-h-[60vh] p-6 bg-gray-50">
    <div className="mb-6">
      ...
      <table className="min-w-full text-left">
        <tbody>
          <tr>
            <td className="font-semibold py-2 pr-4 text-gray-600">Producto:</td>
            <td>{productos.find((producto) => producto.id_producto === selectedFicha.id_producto)?.nombre || 'Desconocido'}</td>
          </tr>
          <tr>
            <td className="font-semibold py-2 pr-4 text-gray-600">Descripción:</td>
            <td>{selectedFicha.descripcion}</td>
          </tr>
          <tr>
            <td className="font-semibold py-2 pr-4 text-gray-600">Insumos:</td>
            <td>{selectedFicha.insumos}</td>
          </tr>
         
          <tr>
            <td className="font-semibold py-2 pr-4 text-gray-600">Creado:</td>
            <td>{new Date(selectedFicha.createdAt).toLocaleString()}</td>
          </tr>
          <tr>
            <td className="font-semibold py-2 pr-4 text-gray-600">Actualizado:</td>
    ...
    <div className="mt-6">
      ...
      <table className="min-w-full mt-2 text-left bg-white rounded-lg shadow-sm">
        <thead>
          <tr className="bg-gray-100">
            <th className="px-4 py-2 text-left font-semibold text-gray-700">Insumo</th>
          ...
          {selectedFicha.detallesFichaTecnicat.map((detalle, index) => {
            return (
              <tr key={index} className="border-b">
                ...
                <td className="px-4 py-2 text-gray-800">{detalle.cantidad}</td>
              </tr>
            );
          })}
        </tbody>
  ...
  <DialogFooter className="bg-white p-4 flex justify-end border-t-2 border-gray-200">
