...
<Dialog open={detailsOpen} handler={handleDetailsOpen} className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
  <DialogHeader className="text-xl font-bold text-gray-800 border-b border-gray-300 py-4">
    Detalles de la Venta
  </DialogHeader>
  <DialogBody divider className="overflow-y-auto max-h-[70vh] p-6">
      ...
      <table className="w-full text-sm border-separate border-spacing-2">
        ...
        <tbody>
          {selectedVenta.detalleVentas.map((detalle) => (
            <tr key={detalle.id_detalle_venta} className="bg-gray-50 border-b border-gray-300">
