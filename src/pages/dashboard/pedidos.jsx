...
>
  ...
  <DialogHeader className="text-lg font-semibold text-gray-800 border-b border-gray-300 pb-4">
    Detalles del Pedido
  </DialogHeader>
  <DialogBody divider className="overflow-y-auto max-h-[60vh] p-4">
        ...
        <table className="min-w-full bg-gray-100 border border-gray-300 rounded-lg">
          <tbody>
            <tr className="border-b border-gray-300">
              <td className="font-semibold p-2">ID Cliente:</td>
              <td className="p-2">{selectedPedido.clientesh.id_cliente}</td>
            </tr>
            <tr className="border-b border-gray-300">
              <td className="font-semibold p-2">Nombre:</td>
              <td className="p-2">{selectedPedido.clientesh.nombre}</td>
            </tr>
            <tr className="border-b border-gray-300">
              <td className="font-semibold p-2">Contacto:</td>
              <td className="p-2">{selectedPedido.clientesh.contacto}</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div className="mb-6">
      ...
      <table className="min-w-full bg-gray-100 border border-gray-300 rounded-lg">
        <tbody>
          <tr className="border-b border-gray-300">
            <td className="font-semibold p-2">ID Pedido:</td>
            <td className="p-2">{selectedPedido.id_pedido}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <td className="font-semibold p-2">Número de Pedido:</td>
            <td className="p-2">{selectedPedido.numero_pedido}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <td className="font-semibold p-2">Fecha de Entrega:</td>
            <td className="p-2">{selectedPedido.fecha_entrega.split('T')[0]}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <td className="font-semibold p-2">Fecha de Pago:</td>
            <td className="p-2">{selectedPedido.fecha_pago ? selectedPedido.fecha_pago.split('T')[0] : "N/A"}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <td className="font-semibold p-2">Estado:</td>
            <td className="p-2">{selectedPedido.estado}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <td className="font-semibold p-2">Pagado:</td>
            <td className="p-2">{selectedPedido.pagado ? "Sí" : "No"}</td>
          </tr>
        </tbody>
      </table>
    </div>
      ...
      <table className="min-w-full bg-gray-100 border border-gray-300 rounded-lg">
        <thead>
          <tr className="bg-gray-200 border-b border-gray-300">
            <th className="font-semibold p-2 text-left">ID Detalle</th>
            <th className="font-semibold p-2 text-left">Producto</th>
            <th className="font-semibold p-2 text-left">Cantidad</th>
          </tr>
        </thead>
        <tbody>
          {selectedPedido.detallesPedido.map((detalle) => (
            <tr key={detalle.id_detalle_pedido} className="border-b border-gray-300">
              <td className="p-2">{detalle.id_detalle_pedido}</td>
              <td className="p-2">{productos.find(p => p.id_producto === detalle.id_producto)?.nombre || 'Producto no encontrado'}</td>
  ...
  <DialogFooter className="flex justify-end pt-4">
    <Button variant="text" className="bg-red-500 text-white hover:bg-red-600" size="sm" onClick={handleDetailsOpen}>
      Cerrar
    </Button>
  </DialogFooter>
</Dialog>
